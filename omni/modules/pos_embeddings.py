...
def apply_rope_real(
    ...
    q_rotated_real = (
        q_real * cos_rotations[None, None, :, :]
        - q_imag * sin_rotations[None, None, :, :]
    )
    q_rotated_imag = (
        q_real * sin_rotations[None, None, :, :]
        + q_imag * cos_rotations[None, None, :, :]
    )
    k_rotated_real = (
        k_real * cos_rotations[None, None, :, :]
        - k_imag * sin_rotations[None, None, :, :]
    )
    k_rotated_imag = (
        k_real * sin_rotations[None, None, :, :]
        + k_imag * cos_rotations[None, None, :, :]
    )
